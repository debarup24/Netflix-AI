...
const Login = () => {
  return (
    <div>
     ...
     <form className='absolute items-center flex-col justify-center px-12 py-8 w-[95%] bg-black md:w-[30%] my-40 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80 '> 
     <h1 className="font-bold text-3xl py-4">Sign In </h1>
      ...
      <br/>
      <p className='items-center flex-col justify-center'> OR, </p>
     </form>
